CACHE_DIR=.cache
LIBABELSDK_DIST_URL=https://github.com/pqabelian/abelian-sdk-go-lib/releases/download/v1.1.0/libabelsdk-1.1.0.tar.gz
LIBABELSDK_DIST_NAME=libabelsdk-1.1.0
